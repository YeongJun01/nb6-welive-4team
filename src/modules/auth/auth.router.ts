...
router
  .route('/signup/super-admin')
  .post(asyncHandler(userController.signUpSuperAdmin.bind(userController)));
...
router
  .route('/admins/status')
  .patch(asyncHandler(userController.updateAdminStatusBulk.bind(userController)));
router
  .route('/admins/:adminId/status')
  .patch(asyncHandler(userController.updateAdminStatus.bind(userController)));
router
  .route('/admins/:adminId')
  .patch(asyncHandler(userController.updateAdminInfo.bind(userController)));
router
  .route('/admins/:adminId')
  .delete(asyncHandler(userController.deleteAdmin.bind(userController)));

router
  .route('/residents/status')
  .patch(asyncHandler(userController.updateResidentStatusBulk.bind(userController)));
router
  .route('/residents/:residentId/status')
  .patch(asyncHandler(userController.updateResidentStatus.bind(userController)));

router
  .route('/cleanup')
  .post(asyncHandler(userController.deleteRejectedUsers.bind(userController)));
